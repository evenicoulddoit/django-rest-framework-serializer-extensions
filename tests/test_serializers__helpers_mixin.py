...
class SerializerHelpersHierarchyTests(TestCase):
    ...
    def test_child_serializer(self):
        self.assertEqual("manufacturer", self.fields["manufacturer"].hierarchy)

    def test_many_child_serializer(self):
        self.assertEqual("skus", self.fields["skus"].child.hierarchy)
    ...
    def test_double_nested_child_serializer(self):
        ...
        self.assertEqual(
            "skus__owners__organization", nested_serializer.hierarchy
        )
...
class RepresentChildTests(TestCase):
    ...
    def test_instance_passed(self):
        self.assertEqual(
            self.internal_value["child"]["id"], self.serialized["child"]["id"]
        )

    def test_context_passed(self):
        self.assertEqual(
            self.context["label"], self.serialized["child"]["context_label"]
        )
