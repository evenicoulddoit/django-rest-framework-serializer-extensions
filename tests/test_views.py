...
class GetSerializerContextTests(CBVTestCase):
    ...
    def test_no_attribute_field_names(self):
        self.assertInContext(
            ...
            dict(
                expand=set(), expand_id_only=set(), exclude=set(), only=set()
            ),
        )
...
class SerializerExtensionsAPIViewMixinTests(TestCase):
    ...
    def test_complex_serialization(self):
        data = self.get_response_data(
            expand="cars", only="cars", exclude="cars__id"
        )
...
class ExternalIdViewMixinTests(TestCase):
    ...
    def setUp(self):
        ...
        class View(ExternalIdViewMixin, test_views.OwnerAPITestView):
            pass
    ...
    def test_matches_against_external_id(self):
        external_id = external_id_from_model_and_internal_id(
    ...
    def test_raises_404_when_not_found(self):
        bad_external_id = external_id_from_model_and_internal_id(
